...
public final class DelayedSeq extends Obj implements ISeq, Sequential, List, IPending, IHashEq{

private IFn fn;
private Object sv;
private Reference<ISeq> s;

public DelayedSeq(IFn fn){
  this.fn = fn;
}

public DelayedSeq(IPersistentMap meta, IFn fn) {
  super(meta);
  this.fn = fn;
}
